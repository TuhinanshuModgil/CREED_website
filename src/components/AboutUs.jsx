  ...
  export default function AboutUs() {
    return (
      <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32 " id="about-us">
        ...
        >
          <div
            className="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-tr from-[#6aa84f] to-[#4a4648] opacity-20"
            style={{
              clipPath:
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
            <div className="sm:grid grid-cols-1 gap-x-8 gap-y-6 text-base font-semibold leading-7 hidden  text-white sm:grid-cols-2 md:flex lg:gap-x-10">
              {links.map((link) => (
