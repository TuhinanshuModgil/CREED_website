...
export default function OurTeam() {
  return (
    ...
    <div className="bg-white py-32 border-b " id='team-section' >
      <div className="mx-auto max-w-7xl px-6 text-center lg:px-8">
        <div className="mx-auto max-w-2xl">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">CREED Faculty Advisory Team</h2>
          <p className="mt-4 text-lg leading-8 text-gray-600">
            Our interdisciplinary team comprises eleven faculty members, including professors, associate professors, and assistant professors, representing diverse disciplines.
          </p>
        </div>
        <ul
          role="list"
    ...
    <div className="bg-white py-32 " id='team-section' >
      <div className="mx-auto max-w-7xl px-6 text-center lg:px-8">
        <div className="mx-auto max-w-2xl">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">KISEM Faculty Advisory Team</h2>
          <p className="mt-4 text-lg leading-8 text-gray-600">
            Our interdisciplinary team for KISEM comprises of faculty seven members, including professors, associate professors, and assistant professors, representing diverse disciplines.
          </p>
        </div>
        <ul
          role="list"
