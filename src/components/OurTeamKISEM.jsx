...
import RenjithRaj from "../assets/images/RenjithRaj.jpg";
import NiranjanMishra from "../assets/images/NiranjanMishra.png";
import KirtiPrasad from "../assets/images/KirtiPrasad.png";
import SumitKumar from "../assets/images/SumitKumar.png";
import RoopaChandran from "../assets/images/RoopaChandran.png";
...
const people = [
  ...
  {
    name: 'Mr.Niranjan Kumar Mishra',
    role: 'Field Engineer, KISEM Project',
    imageUrl: NiranjanMishra,
    xUrl: '#',
    linkedinUrl: '#',
  },
  {
    name: 'Mr. Kirit Prasad',
    role: 'Field Engineer, KISEM Project',
    imageUrl: KirtiPrasad,
    xUrl: '#',
    linkedinUrl: '#',
  },
  {
    name: 'Mrs. Roopa Chandran',
    role: 'Field Engineer, KISEM Project',
    imageUrl: RoopaChandran,
    xUrl: '#',
    linkedinUrl: '#',
  }
]

export default function OurTeamKISEM() {
  return (
    <div className="bg-white py-32 border-t" id='team-section' >
      <div className="mx-auto max-w-7xl px-6 text-center lg:px-8">
        <div className="mx-auto max-w-2xl">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Meet our KISEM team</h2>
