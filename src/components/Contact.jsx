        ...
        <form action="#" method="POST" className="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
            <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
              ...
              <label htmlFor="organisation-name" className="block text-sm font-semibold leading-6 text-gray-900">
                  Organisation Name
                </label>
                <div className="mt-2.5">
                  <input
            ...
            <div className="mt-8 flex justify-end">
              <button
                type="submit"
                className="rounded-md bg-tertairy-color-one px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-green-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-800"
              >
                Send message
              </button>
            </div>
